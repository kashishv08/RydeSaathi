...
function Register() {
    ...
    const { mutate, data, error, isError } = useSendOtp()
                        ...
                        <>
                            ...
                            <form action="" method="post" onSubmit={handleSendOtp}>
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm bg-white focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all">
                                ...
                                <Link to={"/login"} className="text-center text-sm font-medium text-gray-500 hover:text-black mt-2 transition-colors">
                                    Login
                                </Link>
