            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-400 mt-2">Connecting destinations, empowering journeys.</p>
                    </div>
                    <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors underline underline-offset-4">
                        Visit Help Center
                    </a>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 border-b border-gray-800 pb-16">
                    ...
                    <div>
                        <h4 className="font-semibold mb-6 text-sm uppercase tracking-wider text-gray-400">Global citizenship</h4>
                        <ul className="space-y-3 text-sm text-gray-400">
                    ...
                    <div>
                        <h4 className="font-semibold mb-6 text-sm uppercase tracking-wider text-gray-400">Travel</h4>
                        <ul className="space-y-3 text-sm text-gray-400">
